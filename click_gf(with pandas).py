...
if os.path.exists('new.H_catalog.csv'): 
    begin = input("Do you want to start where you left off? enter 'no' if you want to star over.: ")
        ...
        if YB_long >=15 and YB_long <57.707:
            ...
            #interactive clicking to fill up coords
               ...
               # coords = clkfig.ginput(n=-1, timeout=300, show_clicks=True, mouse_stop=2)
                ...
                compound_model_bounded.stddev.bounds = (0,1)
